...
- (NSArray<NSLayoutConstraint *> *)setCenterConstraint:(CGPoint)center toView:(UIView *)view
{
    NSLayoutConstraint *centerXConstraint = [self setCenterXConstraint:center.x toView:view];
    NSLayoutConstraint *centerYConstraint = [self setCenterYConstraint:center.y toView:view];
